...
export default function SubjectCard({ quiz, progress, onSelectMode }) {
  ...
  return (
    <div className="group relative bg-white dark:bg-slate-900 rounded-3xl p-6 border border-warm-border dark:border-slate-800 shadow-soft hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between overflow-hidden">
      {/* Top Accent Line */}
      ...
      <div>
        ...
        {/* Title & Subject */}
        <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-slate-100 leading-snug group-hover:text-warm-slate dark:group-hover:text-slate-300 transition-colors">
          {quiz.title}
        </h3>
      ...
      <div className="grid grid-cols-3 gap-2 mt-6 pt-4 border-t border-warm-border/40 dark:border-slate-800">
        <button
          ...
          className="flex flex-col items-center justify-center p-2.5 rounded-2xl bg-amber-50 dark:bg-amber-950/50 hover:bg-amber-100 dark:hover:bg-amber-900/60 text-amber-900 dark:text-amber-300 border border-amber-200/80 dark:border-amber-800 text-[11px] font-bold transition-all active:scale-95 gap-1"
        ...
        <button
          ...
          className="flex flex-col items-center justify-center p-2.5 rounded-2xl bg-indigo-50 dark:bg-indigo-950/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-900 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800 text-[11px] font-bold transition-all active:scale-95 gap-1"
        ...
        <button
          ...
          className="flex flex-col items-center justify-center p-2.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/50 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 text-emerald-900 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-800 text-[11px] font-bold transition-all active:scale-95 gap-1"
